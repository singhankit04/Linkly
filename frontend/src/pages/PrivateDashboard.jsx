...
import { Search, Link as LinkIcon, Copy, Check, BarChart2, Clock, Lock, LogIn, Plus, MessageSquare } from 'lucide-react';
...
const PrivateDashboard = () => {
      ...
      <div className="min-h-screen bg-[#0a0710] font-sans text-gray-200 flex items-center justify-center p-4">
        ...
        >
          ...
          <p className="text-gray-400 text-sm mb-8">
            You need to be logged in to access the Private Dashboard and view your personal links.
          </p>
          <Link to="/">
  ...
  return (
    <div className="min-h-screen bg-[#0a0710] font-sans text-gray-200 relative overflow-hidden flex flex-col items-center pt-28 pb-12 px-4 sm:px-6">
      {/* Background Orbs */}
      <div className="absolute top-[10%] right-[-10%] w-[40%] h-[40%] bg-purple-900/20 blur-[120px] rounded-full pointer-events-none" />
      ...
      <div className="w-full max-w-7xl z-10 flex flex-col">
        ...
        <div className="mb-10 text-center lg:text-left">
          ...
          >
            Create and manage your private, secure short links.
          </motion.p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            >
              ...
              <form onSubmit={handleShorten} className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-1.5 w-full">
                  ...
                  <textarea
                    placeholder="Add a secret message for your private link..."
                    value={secretMessage}
          ...
          {/* RIGHT COLUMN: Private Links List */}
